...
{
    /// <summary>
    /// Package version following the semantic version specification.
    /// </summary>
    ...
    public sealed class SemanticVersion(int major, int minor, int patch, string? preRelease = null, string? buildMetadata = null)
        : IVersion, IEquatable<SemanticVersion>
    {
        /// <summary>
