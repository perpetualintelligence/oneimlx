...
namespace PerpetualIntelligence.OneImlx.Licensing
{
    ...
    public interface ILicenseManager
    {
        ...
        /// <returns><c>true</c> if a valid license exists for the identity to access the resource; <c>false</c> otherwise.</returns>
        ...
        /// <param name="resource">The target resource to be accessed.</param>
        /// <param name="license">Output parameter that contains the applicable license, if one exists among the identities; otherwise, <c>null</c>.</param>
        /// <returns><c>true</c> if valid licenses exist for all the principal's identities to access the resource; <c>false</c> otherwise.</returns>
        bool HasLicenseFor(ILicensePrincipal principal, ILicenseResource resource, out License? license);

        /// <summary>
        /// Assesses whether the identity, identified by its ID, possesses a license to access the resource defined by its ID.
        /// </summary>
        ...
        /// <returns><c>true</c> if a valid license is found for the given identity to access the specified resource; <c>false</c> otherwise.</returns>
