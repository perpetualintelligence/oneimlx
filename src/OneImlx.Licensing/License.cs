...
namespace OneImlx.Licensing
{
    ...
    /// </summary>
    /// <remarks>
    /// A license is granted to a set of <see cref="ILicensePrincipal"/> objects allowing them to utilize a set of
    /// <see cref="ILicenseResource"/> objects. The license class can be understood as an association between multiple
    /// principals and multiple resources, without implying that every principal has access to every resource. It allows
    /// for the flexibility of complex licensing relationships where some principals may have licenses for specific
    ...
    public sealed class License
    {
        ...
        /// Specifies the target system if the license is shared across the entire system or a specific sub-system.
        /// </param>
        ...
        /// <summary>
        /// Specifies the target system if the license is applicable as a shared license across either the entire system
        /// or a particular sub-system.
        /// </summary>
