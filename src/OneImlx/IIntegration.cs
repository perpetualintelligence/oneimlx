...
namespace PerpetualIntelligence.OneImlx
{
    ...
    /// encompassing aspects such as localization preferences and references to external system records.
    /// </summary>
    public interface IIntegration
    {
        ...
        /// The primary locale, situated at the beginning of the list, becomes the default choice for most interactions and operations.
        /// Subsequent locales signify additional languages or regions that the identity either endorses or can comfortably accommodate.
